...
wav = tts.tts(text=text, speaker_wav="my/cloning/combined.wav", language="en")

tts.tts_to_file(text=text, speaker_wav="my/cloning/combined.wav", language="en", file_path="output2.wav")
